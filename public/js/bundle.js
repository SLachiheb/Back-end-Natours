...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FyYWhsYWNoaWhlYiIsImEiOiJja2w2ZWh0dm8wb2l5MnNxcDA0dmVmdXAzIn0.ePp523YmpadLfoKg1Nl7kw';
...
var udpateUserData = /*#__PURE__*/function () {
  ...
  return function udpateUserData(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.udpateUserData = udpateUserData;
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  (0, _updateSettings.udpateUserData)(name, email);
});
